...
from helium_integrationtest.util import is_osx, TemporaryAttrValue
...
class AlertAT(object):
	...
	before the JavaScript in inttest_alert.html has set the corresponding
	result.
	"""
...
class AlertIT(AlertAT, BrowserAT):
	def get_link_to_open_alert(self):
...
class ConfirmationDialogIT(AlertAT, BrowserAT):
	def get_link_to_open_alert(self):
...
class PromptIT(AlertAT, BrowserAT):
	def get_link_to_open_alert(self):
